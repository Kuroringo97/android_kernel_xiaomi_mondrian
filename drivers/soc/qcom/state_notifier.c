...
bool state_suspended_1;
EXPORT_SYMBOL(state_suspended_1);
module_param_named(state_suspended_1, state_suspended_1, bool, 0444);
...
void state_suspend(void)
{
	...
	if (state_suspended_1 || suspend_in_progress)
		return;
